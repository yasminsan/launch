 ...
 */
        ...
        , function(t, e, n) {
            var r = n(3)
              ...
              , s = n(29)
              , u = function(t, e, n) {
                var c, l, f, h, d = t & u.F, p = t & u.G, g = t & u.S, v = t & u.P, y = t & u.B, m = p ? r : g ? r[e] || (r[e] = {}) : (r[e] || {}).prototype, b = p ? i : i[e] || (i[e] = {}), x = b.prototype || (b.prototype = {});
                for (c in p && (n = e),
                n)
                    f = ((l = !d && m && void 0 !== m[c]) ? m : n)[c],
                    h = y && l ? s(f, r) : v && "function" == typeof f ? s(Function.call, f) : f,
                    m && a(m, c, f, t & u.U),
                    b[c] != f && o(b, c, h),
                    v && x[c] != f && (x[c] = f)
            };
        ...
        , function(t, e, n) {
            ...
            i(i.S + i.F * !n(60)((function(t) {
                ...
                from: function(t) {
                    var e, n, i, f, h = o(t), d = "function" == typeof this ? this : Array, p = arguments.length, g = p > 1 ? arguments[1] : void 0, v = void 0 !== g, y = 0, m = l(h);
                    if (v && (g = r(g, p > 2 ? arguments[2] : void 0, 2)),
                    null == m || d == Array && s(m))
        ...
        , function(t, e, n) {
            for (var r = n(45), i = n(13), o = n(10), a = n(3), s = n(6), u = n(18), c = n(0), l = c("iterator"), f = c("toStringTag"), h = u.Array, d = {
                ...
                var v, y = p[g], m = d[y], b = a[y], x = b && b.prototype;
                if (x && (x[l] || s(x, l, h),
                x[f] || s(x, f, y),
                u[y] = h,
                m))
        ...
        , function(t, e, n) {
            ...
            t.exports = function(t, e, n, p, g, v, y) {
                ...
                }, S = e + " Iterator", C = "values" == g, w = !1, O = t.prototype, T = O[f] || O["@@iterator"] || g && O[g], _ = T || P(g), E = g ? C ? P("entries") : _ : void 0, A = "Array" == e && O.entries || T;
                if (A && (x = l(A.call(new t))) !== Object.prototype && x.next && (c(x, S, !0),
                r || "function" == typeof x[f] || a(x, f, d)),
                C && T && "values" !== T.name && (w = !0,
                _ = function() {
                    return T.call(this)
                }
                ),
        ...
        , function(t, e, n) {
            ...
            : function(t) {
              ...
              , G = function(t, e, n) {
                ...
                e = P(e, !0),
                m(n),
                i(D, e) ? (n.enumerable ? (i(t, L) && t[L][e] && (t[L][e] = !1),
                n = C(n, {
                    enumerable: S(0, !1)
                })) : (i(t, L) || A(t, L, S(1, {})),
                t[L][e] = !0),
              ...
              , Q = function(t) {
                for (var e, n = t === F, r = M(n ? W : x(t)), o = [], a = 0; r.length > a; )
        ...
        , function(t, e, n) {
            ...
            t.exports = {
                set: Object.setPrototypeOf || ("__proto__"in {} ? function(t, e, r) {
                    try {
                        (r = n(29)(Function.call, n(37).f(Object.prototype, "__proto__").set, 2))(t, []),
        ...
        , function(t, e, n) {
            ...
            t.exports = !u || n(1)((function() {
                ...
                for (var n = a(t), u = arguments.length, c = 1, l = i.f, f = o.f; u > c; )
                    for (var h, d = s(arguments[c++]), p = l ? r(d).concat(l(d)) : r(d), g = p.length, v = 0; g > v; )
            ...
            var c = u.exports
              , l = function() {
                ...
                return r("div", {
                    ...
                    class: (t = {},
                    t["VueCarousel-pagination--" + e.paginationPositionModifierName] = e.paginationPositionModifierName,
                    t)
                }, [r("div", {
            ...
            var f = {
                ...
                methods: {
                    ...
                    dotStyle: function(t) {
                        var e = this.carousel
                          , n = {};
                        if (n["margin-".concat(this.paginationPropertyBasedOnPosition)] = "".concat(2 * e.paginationPadding, "px"),
                        Object.assign(n, {
            ...
            var g = {
                ...
                methods: {
                    onTouchEnd: function(t) {
                        ...
                        this.$emit("slide-click", Object.assign({}, t.currentTarget.dataset)))
                    }
                }
            }
              , v = (n(99),
              ...
              , S = {
                ...
                watch: {
                    ...
                    navigateTo: {
                        ...
                        handler: function(t) {
                            var e = this;
                            "object" === b(t) ? (0 == t[1] && (this.dragging = !0,
                            setTimeout((function() {
                                e.dragging = !1
                            }
                            ), this.refreshRate)),
                ...
                methods: {
                        ...
                        if (e) {
                            ...
                            this.mutationObserver = new e((function() {
                                t.$nextTick((function() {
                                    ...
                                    t.computeCarouselHeight()
                                }
                                ))
                            }
                            )),
                            this.$parent.$el)
                                for (var r = this.$el.getElementsByClassName("VueCarousel-inner"), i = 0; i < r.length; i++)
                    ...
                    getCarouselHeight: function() {
                        ...
                        return this.currentHeight = 0 === n ? "auto" : "".concat(n, "px"),
                        this.currentHeight
                    },
                    ...
                    goToPage: function(t, e) {
                        t >= 0 && t <= this.pageCount && (this.offset = this.scrollPerPage ? Math.min(this.slideWidth * this.currentPerPage * t, this.maxOffset) : this.slideWidth * t,
                        this.autoplay && !this.autoplayHoverPause && this.restartAutoplay(),
                        this.currentPage = t,
                        "pagination" === e && (this.pauseAutoplay(),
                        this.$emit("pagination-click", t)))
                    },
                    onStart: function(t) {
                        2 != t.button && (document.addEventListener(this.isTouch ? "touchend" : "mouseup", this.onEnd, !0),
                    ...
                    onEnd: function(t) {
                        ...
                        var e = this.isTouch ? t.changedTouches[0].clientX : t.clientX
                          , n = this.dragStartX - e;
                        if (this.dragMomentum = n / (t.timeStamp - this.startTime),
                        0 !== this.minSwipeDistance && Math.abs(n) >= this.minSwipeDistance) {
