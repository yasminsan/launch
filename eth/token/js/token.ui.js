...
async function connect() {
    //conecta com provedor e pega contas
    if (window.ethereum) {
        await ethereum.request({ method: 'eth_requestAccounts' });
    }
    // recebe as contas e altera a rede   
    ...
    //trata a mudança de contas e pega a nova rede com o método acima    
...
async function getNetwork() {
    // recebe a rede e checa o id da cadeia
    network = await provider.getNetwork();
    curnet = network.chainId;
    //    $('#curnetid').html(curnet);
    //compara se a rede+ida da cadeia igual a mainnet ou mainnet alternativa
    if (curnet == mainnet || curnet == mainnetAlt) {
        contractAddress = contractAddressMain;
        $('#curnet').html(mainnetname);
        //passa para o html o nome da rede
        tracker = trackerMain;
        getAddress();
        init();
        //pega endereço e inicia

    } else if (curnet == testnet) {
        // msm coisa da anterior só que para a rede de teste
        contractAddress = contractAddressTest;
        $('#curnet').html(testnetname);
        // Tracker = Links para checar as transações da rede
        tracker = trackerTest;
        getAddress();
        init();
...
async function getAddress() {
    // signer = assinador, ele pega a carteira conectada como o assinador
    // essa função pega o endereço da carteira, atribui como dono e printa
...
async function startApp() {
    // chama as funções existentes até aqui, tipo um inicializador
    ...
    //!!!!!!!!!!!!!!!!!!!!!!!ESTUDARRRRRR!!!!!!!!!!!!!!!!!!!!!!!!!
    // monta as infos do contrato (ABI, endereço e provedor)
