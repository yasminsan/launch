...
$jscomp.polyfill("Promise", function(a) {
    ...
    e.prototype.createResolveAndReject_ = function() {
        function c(l) { return function(n) { h || (h = !0, l.call(g, n)) } }
        var g = this,
            h = !1;
    ...
    e.prototype.then = function(c, g) {
        function h(p, q) { return "function" == typeof p ? function(r) { try { l(p(r)) } catch (t) { n(t) } } : q }
        var l, n, m = new e(function(p, q) {
            l = p;
            n = q
        });
        this.callWhenSettled_(h(c, l), h(g, n));
        return m
    };
...
var contractAddressMain = "0x2AeD5728f05Ac508f8bc0E0d6d62194680e24857",
    contractAddressTest = "0xc17d639183961deafa9b489f9985c8c66c628434",
    builderCost, maxDecimals = 18,
    contractThis, contractThisSign, balanceEth, thisDecimals, abi = [{ inputs: [{ internalType: "uint256", name: "_cost", type: "uint256" }], stateMutability: "nonpayable", type: "constructor" }, {
        anonymous: !1,
        inputs: [{ indexed: !0, internalType: "address", name: "tokenCreator", type: "address" }, { indexed: !0, internalType: "address", name: "tokenAddress", type: "address" }, {
            ...
            name: "name",
            type: "string"
        }, { indexed: !1, internalType: "string", name: "symbol", type: "string" }, { indexed: !1, internalType: "uint256", name: "decimals", type: "uint256" }, { indexed: !1, internalType: "uint256", name: "totalSupply", type: "uint256" }],
        name: "TokenCreated",
        type: "event"
    ...
    abiToken = [{ inputs: [{ internalType: "string", name: "_name", type: "string" }, { internalType: "string", name: "_symbol", type: "string" }, { internalType: "uint256", name: "_dec", type: "uint256" }, { internalType: "uint256", name: "_supply", type: "uint256" }, { internalType: "address", name: "_owner", type: "address" }], stateMutability: "nonpayable", type: "constructor" }, {
        ...
        stateMutability: "view",
        type: "function"
    }, { inputs: [], name: "name", outputs: [{ internalType: "string", name: "", type: "string" }], stateMutability: "view", type: "function" }, { inputs: [], name: "symbol", outputs: [{ internalType: "string", name: "", type: "string" }], stateMutability: "view", type: "function" }, { inputs: [], name: "totalSupply", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, {
        inputs: [{
            internalType: "address",
            name: "to",
            type: "address"
...
function init() {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(a) {
        ...
        contract.on(filter, function(b, d, f, e, k, c) {
            console.log("New token - " + f + " (" + e + ") - created at address " + d + ".");
            makeTable()
        });
        makeTable();
        a.jumpToEnd()
...
function makeTable() {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(m) {
        switch (m.nextAddress) {
            ...
            case 8:
                return g = m.yieldResult, m.yield(k.decimals(),
                    9);
            case 9:
                return h = m.yieldResult, m.yield(k.totalSupply(), 10);
            case 10:
                l = m.yieldResult;
                n = Number(f + 1);
                a = a + '<div class="tokenrow"><div class="no">' + n + '</div><div class="addresss"><a target="_blank" title="View on explorer" href="' + tracker + "token/" + e + '">' + e + '</a></div><div class="name">' + c + "(" + g + ')</div><div class="supply">' + ethers.utils.formatUnits(l, h) + '</div><div class="decimals">' + Number(h) + '</div><div class="add"><span title="Add to wallet" class="clickable" onclick="watchToken(\'' + e + "', '" + g + "', " +
                    h + ')">Add</span></div>';
                a += "</div>";
                f++;
                m.jumpTo(4);
...
$("#buildbtn").click(function() {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(k) {
        if (1 == k.nextAddress) {
            ...
            f = $("#newdecimals").val();
            e = $("#newto").val();
            if (!("" != a && "" != b && 0 < d && f && 18 >= f && "" != e && ethers.utils.isAddress(e))) return $("#errors").html("Error: fields are empty or incorrect!"), k.jumpTo(0);
            $("#errors").html("");
            return k.yield(contractSign.createToken(a, b, f, d, e, { value: builderCost, gasLimit: 2E6 }), 3)
        }
        tx =
            k.yieldResult;
        $("#errors").html(tx);
