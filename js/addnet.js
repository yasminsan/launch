...
$jscomp.polyfill = function(a, b, d, e) { b && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(a, b, d, e) : $jscomp.polyfillUnisolated(a, b, d, e)) };
...
$jscomp.polyfillIsolated = function(a, b, d, e) {
    ...
    b = b(d);
    null != b && (a ? $jscomp.defineProperty($jscomp.polyfills, f, { configurable: !0, writable: !0, value: b }) : b !== d && (void 0 === $jscomp.propertyToPolyfillSymbol[f] && (d = 1E9 * Math.random() >>> 0, $jscomp.propertyToPolyfillSymbol[f] = $jscomp.IS_SYMBOL_NATIVE ?
...
$jscomp.generator.Engine_.prototype.yieldAllStep_ = function(a, b, d) {
    try {
        ...
        var f = e.value
    } catch (l) { return this.context_.yieldAllIterator_ = null, this.context_.throw_(l), this.nextStep_() }
...
$jscomp.asyncExecutePromiseGenerator = function(a) {
    function b(e) { return a.next(e) }

    function d(e) { return a["throw"](e) }
    return new Promise(function(e, f) {
        function l(c) { c.done ? e(c.value) : Promise.resolve(c.value).then(b, d).then(l, f) }
        l(a.next())
    })
};
...
$jscomp.polyfill("Symbol", function(a) {
    ...
    var d = "jscomp_symbol_" + (1E9 * Math.random() >>> 0) + "_",
        e = 0,
        f = function(l) { if (this instanceof f) throw new TypeError("Symbol is not a constructor"); return new b(d + (l || "") + "_" + e++, l) };
    return f
}, "es6", "es3");
...
$jscomp.polyfill("Promise", function(a) {
    ...
    function d(c) { return c instanceof f ? c : new f(function(g, h) { g(c) }) }
    ...
    b.prototype.asyncExecuteFunction = function(c) { e(c, 0) };
    b.prototype.executeBatch_ = function() {
        for (; this.batch_ && this.batch_.length;) {
            ...
            for (var g = 0; g < c.length; ++g) {
                var h = c[g];
                c[g] = null;
                try { h() } catch (k) { this.asyncThrow_(k) }
            }
        }
        this.batch_ = null
    };
    ...
    f.prototype.createResolveAndReject_ = function() {
        function c(k) { return function(m) { h || (h = !0, k.call(g, m)) } }
        var g = this,
            h = !1;
    ...
    f.prototype.resolveToNonPromiseObj_ = function(c) { var g = void 0; try { g = c.then } catch (h) { this.reject_(h); return } "function" == typeof g ? this.settleSameAsThenable_(g, c) : this.fulfill_(c) };
    f.prototype.reject_ = function(c) { this.settle_(2, c) };
    ...
    f.prototype.scheduleUnhandledRejectionCheck_ = function() {
        var c = this;
        e(function() { if (c.notifyUnhandledRejection_()) { var g = $jscomp.global.console; "undefined" !== typeof g && g.error(c.result_) } }, 1)
    };
    ...
    f.prototype.settleSameAsThenable_ = function(c, g) { var h = this.createResolveAndReject_(); try { c.call(g, h.resolve, h.reject) } catch (k) { h.reject(k) } };
    f.prototype.then = function(c, g) {
        function h(n, p) { return "function" == typeof n ? function(q) { try { k(n(q)) } catch (r) { m(r) } } : p }
    ...
    f.resolve = d;
    f.reject = function(c) { return new f(function(g, h) { h(c) }) };
    f.race = function(c) { return new f(function(g, h) { for (var k = $jscomp.makeIterator(c), m = k.next(); !m.done; m = k.next()) d(m.value).callWhenSettled_(g, h) }) };
    f.all = function(c) {
...
var testBSC = { chainId: "0x61", chainName: "Binance Smart Chain Testnet", nativeCurrency: { name: "Binance Coin", symbol: "BNB", decimals: 18 }, rpcUrls: ["https://data-seed-prebsc-2-s1.binance.org:8545/"], blockExplorerUrls: ["https://testnet.bscscan.com"] };
...
var mainMATIC = { chainId: "0x89", chainName: "Polygon (MATIC) Mainnet", nativeCurrency: { name: "Polygon", symbol: "MATIC", decimals: 18 }, rpcUrls: ["https://polygon-rpc.com/"], blockExplorerUrls: ["https://polygonscan.com/"] };
$("#addMainMATIC").click(function() {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(a) {
        window.ethereum ? ethereum.request({ method: "wallet_addEthereumChain", params: [mainMATIC] })["catch"](function(b) { return console.log(b.message) }) : $("#nometamask").fadeIn(1E3).fadeOut(1E3);
        a.jumpToEnd()
    })
});
var testMATIC = { chainId: "0x13881", chainName: "Polygon (MATIC) Mumbai Testnet", nativeCurrency: { name: "Polygon", symbol: "MATIC", decimals: 18 }, rpcUrls: ["https://rpc-mumbai.maticvigil.com/"], blockExplorerUrls: ["https://mumbai.polygonscan.com/"] };
$("#addTestMATIC").click(function() {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(a) {
        window.ethereum ? ethereum.request({ method: "wallet_addEthereumChain", params: [testMATIC] })["catch"](function(b) { return console.log(b.message) }) : $("#nometamask").fadeIn(1E3).fadeOut(1E3);
        a.jumpToEnd()
    })
});
var mainThunderCore = { chainId: "0x6c", chainName: "ThunderCore Mainnet", nativeCurrency: { name: "Thunder Token", symbol: "TT", decimals: 18 }, rpcUrls: ["https://mainnet-rpc.thundercore.com"], blockExplorerUrls: ["https://scan.thundercore.com"] };
$("#addMainThunderCore").click(function() {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(a) {
        window.ethereum ? ethereum.request({ method: "wallet_addEthereumChain", params: [mainThunderCore] })["catch"](function(b) { return console.log(b.message) }) : $("#nometamask").fadeIn(1E3).fadeOut(1E3);
        a.jumpToEnd()
    })
});
var testThunderCore = { chainId: "0x12", chainName: "ThunderCore Testnet", nativeCurrency: { name: "Thunder Token", symbol: "TT", decimals: 18 }, rpcUrls: ["https://testnet-rpc.thundercore.com"], blockExplorerUrls: ["https://scan-testnet.thundercore.com"] };
$("#addTestThunderCore").click(function() {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(a) {
        window.ethereum ? ethereum.request({ method: "wallet_addEthereumChain", params: [testThunderCore] })["catch"](function(b) { return console.log(b.message) }) : $("#nometamask").fadeIn(1E3).fadeOut(1E3);
        a.jumpToEnd()
    })
});
$("#connect").on("click", function() {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(e) {
        if (1 == e.nextAddress) {
            ...
            return e.yield(ethereum.request({ method: "eth_requestAccounts" }), 5)
        }
        if (3 != e.nextAddress) { a = e.yieldResult; if (b = a[0]) $("#connected").html(b), $("#connected").fadeIn(1E3).fadeOut(1E3); return e.leaveTryBlock(0) }
        d = e.enterCatchBlock();
        console.error(d);
        e.jumpToEnd()
    })
