...
$jscomp.polyfill("Promise", function(a) {
    ...
    b.prototype.executeBatch_ = function() {
        for (; this.batch_ && this.batch_.length;) {
            ...
            for (var g = 0; g < c.length; ++g) {
                var h = c[g];
                c[g] = null;
                try { h() } catch (l) { this.asyncThrow_(l) }
            }
        }
        this.batch_ = null
    };
    ...
    e.prototype.createResolveAndReject_ = function() {
        function c(l) { return function(m) { h || (h = !0, l.call(g, m)) } }
        var g = this,
            h = !1;
    ...
    e.prototype.then = function(c, g) {
        function h(n, p) { return "function" == typeof n ? function(q) { try { l(n(q)) } catch (r) { m(r) } } : p }
    ...
    e.race = function(c) { return new e(function(g, h) { for (var l = $jscomp.makeIterator(c), m = l.next(); !m.done; m = l.next()) d(m.value).callWhenSettled_(g, h) }) };
    e.all = function(c) {
...
var contractAddressMain = "0x4fCBe5EBAD504C0Db8483E721343BDC353595603",
    contractAddressTest = "0xc922efc865436117055608b7a908e23e75da48f0",
    builderCost, maxDecimals = 18;

function init() {
    var a;
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(b) {
        if (1 == b.nextAddress) return a = [{ inputs: [{ internalType: "uint256", name: "_cost", type: "uint256" }], stateMutability: "nonpayable", type: "constructor" }, { anonymous: !1, inputs: [{ indexed: !0, internalType: "address", name: "oldBeneficiary", type: "address" }, { indexed: !0, internalType: "address", name: "newBeneficiary", type: "address" }], name: "BeneficiarySet", type: "event" }, {
            anonymous: !1,
            inputs: [{
                indexed: !1,
            ...
            anonymous: !1,
            inputs: [{ indexed: !0, internalType: "address", name: "tokenCreator", type: "address" }, { indexed: !0, internalType: "address", name: "tokenAddress", type: "address" }, { indexed: !1, internalType: "string", name: "name", type: "string" }, {
                indexed: !1,
                internalType: "string",
                name: "symbol",
                type: "string"
            }, { indexed: !1, internalType: "uint256", name: "totalSupply", type: "uint256" }, { indexed: !1, internalType: "uint8", name: "decimals", type: "uint8" }],
            name: "TokenCreated",
            type: "event"
        }, { inputs: [], name: "beneficiary", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "address", name: "newBeneficiary", type: "address" }], name: "changeBeneficiary", outputs: [], stateMutability: "nonpayable", type: "function" }, {
            inputs: [{
                internalType: "uint256",
                name: "_newcost",
                type: "uint256"
            ...
            type: "function"
        }, { inputs: [{ internalType: "address", name: "newOwner", type: "address" }], name: "changeOwner", outputs: [], stateMutability: "nonpayable", type: "function" }, { inputs: [], name: "cost", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, {
            inputs: [{ internalType: "string", name: "name", type: "string" }, { internalType: "string", name: "symbol", type: "string" }, {
                internalType: "uint256",
                name: "totalSupply",
                type: "uint256"
            }, { internalType: "uint8", name: "decimals", type: "uint8" }, { internalType: "address", name: "to", type: "address" }],
            name: "createToken",
            ...
            name: "getTokenData",
            outputs: [{ internalType: "string", name: "name", type: "string" }, { internalType: "string", name: "symbol", type: "string" }, { internalType: "uint256", name: "totalSupply", type: "uint256" },
                { internalType: "uint256", name: "decimals", type: "uint256" }
            ],
            stateMutability: "view",
            type: "function"
        }, { inputs: [], name: "myTokens", outputs: [{ internalType: "address[]", name: "", type: "address[]" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "address", name: "", type: "address" }, { internalType: "uint256", name: "", type: "uint256" }], name: "mytokens", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, {
            inputs: [],
            name: "owner",
            outputs: [{
            ...
            stateMutability: "view",
            type: "function"
        }, { inputs: [{ internalType: "address", name: "", type: "address" }], name: "tokens", outputs: [{ internalType: "string", name: "name", type: "string" }, { internalType: "string", name: "symbol", type: "string" }, { internalType: "uint256", name: "totalSupply", type: "uint256" }, { internalType: "uint8", name: "decimals", type: "uint8" }], stateMutability: "view", type: "function" }, { inputs: [], name: "withdraw", outputs: [], stateMutability: "nonpayable", type: "function" }], contract = new ethers.Contract(contractAddress,
            a, provider), contractSign = contract.connect(signer), b.yield(contract.cost(), 2);
        builderCost = b.yieldResult;
        $("#buildercost").html(ethers.utils.formatEther(builderCost));
        $("#newto").val(myAddress);
        filter = contract.filters.TokenCreated(myAddress);
        contract.on(filter, function(d, f, e, k, c, g) {
            console.log("New token - " + e + " (" + k + ") - created at address " + f + ".");
            makeTable()
        });
        makeTable();
        b.jumpToEnd()
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(m) {
        switch (m.nextAddress) {
            ...
            case 4:
                ...
                return m.yield(contract.getTokenData(d[f]), 7);
            case 7:
                e = m.yieldResult;
                k = e.name;
                c = e.symbol;
                ...
                h = e.decimals;
                l = Number(f + 1);
                a = a + "<tr><td>" + l + '</td><td><a title="View on explorer" target="_blank" href="' +
                    tracker + "token/" + d[f] + '">' + d[f] + "</a></td><td>" + k + "</td><td>" + c + "</td><td>" + g + "</td><td>" + h + '</td><td><span title="Add to wallet" class="clickable" onclick="watchToken(\'' + d[f] + "', '" + c + "', " + h + ')">add</span></td>';
                a += "</tr>";
                f++;
                m.jumpTo(4);
                break;
...
function watchToken(a, b, d) {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(f) {
        ethereum.request({ method: "wallet_watchAsset", params: { type: "ERC20", options: { address: a, symbol: b, decimals: d } } });
        f.jumpToEnd()
    })
}
$("#buildbtn").click(function() {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(k) {
        ...
        if (1 == k.nextAddress) {
            ...
            e = $("#newto").val();
            "" == e && (e = myAddress);
            if (!("" != a && "" != b && 0 < d && f && 18 >= f)) return $("#errors").html("Error: fields are empty or incorrect!"), k.jumpTo(0);
            $("#errors").html("");
            return k.yield(contractSign.createToken(String(a), String(b), String(d), String(f), String(e), {
                value: builderCost,
                gasLimit: 2E6
            }), 3)
        }
...
$("#newdecimals").change(function() {
    ...
    0 > decval && $("#newdecimals").val(0);
    decval > maxDecimals && $("#newdecimals").val(maxDecimals)
});