...
$jscomp.polyfill("Symbol", function(a) {
    ...
    var d = "jscomp_symbol_" + (1E9 * Math.random() >>> 0) + "_",
        f = 0,
        e = function(k) { if (this instanceof e) throw new TypeError("Symbol is not a constructor"); return new b(d + (k || "") + "_" + f++, k) };
    return e
}, "es6", "es3");
...
$jscomp.polyfill("Promise", function(a) {
    ...
    b.prototype.executeBatch_ = function() {
        for (; this.batch_ && this.batch_.length;) {
            ...
            for (var g = 0; g < c.length; ++g) {
                var h = c[g];
                c[g] = null;
                try { h() } catch (m) { this.asyncThrow_(m) }
            }
        }
        this.batch_ = null
    };
    ...
    e.prototype.createResolveAndReject_ = function() {
        function c(m) { return function(n) { h || (h = !0, m.call(g, n)) } }
        var g = this,
            h = !1;
    ...
    e.prototype.settleSameAsThenable_ = function(c, g) { var h = this.createResolveAndReject_(); try { c.call(g, h.resolve, h.reject) } catch (m) { h.reject(m) } };
    e.prototype.then = function(c, g) {
        function h(l, p) { return "function" == typeof l ? function(r) { try { m(l(r)) } catch (t) { n(t) } } : p }
        var m, n, q = new e(function(l, p) {
            m = l;
            n = p
        });
        this.callWhenSettled_(h(c, m), h(g, n));
        return q
    };
    ...
    e.race = function(c) { return new e(function(g, h) { for (var m = $jscomp.makeIterator(c), n = m.next(); !n.done; n = m.next()) d(n.value).callWhenSettled_(g, h) }) };
    e.all = function(c) {
        var g = $jscomp.makeIterator(c),
            h = g.next();
        return h.done ? d([]) : new e(function(m,
            n) {
            function q(r) {
                return function(t) {
                    l[r] = t;
            ...
            var l = [],
                p = 0;
            do l.push(void 0), p++, d(h.value).callWhenSettled_(q(l.length - 1), n), h = g.next(); while (!h.done)
        })
    };
    return e
}, "es6", "es3");
$(".erc").html(" (BEP-20)");
$(".changenet").each(function() { this.href += "cappedmintabletoken/" });
var contractAddressMain = "0xeE4B8458741492455d7B9929F87342Aed9D4eF4b",
    contractAddressTest = "0xBFFEfDCC6275bd0D6703fCe006bB69e2a06Fb4B6",
    builderCost, contractThis, contractThisSign, balanceEth, thisDecimals, thisAddress, maxDecimals = 18,
    abi = [{ inputs: [{ internalType: "uint256", name: "_cost", type: "uint256" }], stateMutability: "nonpayable", type: "constructor" }, {
        ...
        inputs: [{ indexed: !0, internalType: "address", name: "tokenCreator", type: "address" }, { indexed: !0, internalType: "address", name: "tokenAddress", type: "address" },
            { indexed: !1, internalType: "string", name: "name", type: "string" }, { indexed: !1, internalType: "string", name: "symbol", type: "string" }, { indexed: !1, internalType: "uint256", name: "cap", type: "uint256" }, { indexed: !1, internalType: "uint256", name: "decimals", type: "uint256" }, { indexed: !1, internalType: "uint256", name: "totalSupply", type: "uint256" }
        ],
        name: "TokenCreated",
        type: "event"
        ...
        type: "function"
    }, { inputs: [{ internalType: "uint256", name: "_newcost", type: "uint256" }], name: "changeCost", outputs: [], stateMutability: "nonpayable", type: "function" }, { inputs: [{ internalType: "address", name: "newOwner", type: "address" }], name: "changeOwner", outputs: [], stateMutability: "nonpayable", type: "function" }, {
        inputs: [],
        name: "cost",
        ...
        stateMutability: "view",
        type: "function"
    }, { inputs: [{ internalType: "address", name: "", type: "address" }, { internalType: "uint256", name: "", type: "uint256" }], name: "mytokens", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, { inputs: [], name: "owner", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, {
        inputs: [],
        name: "totalBuilt",
        outputs: [{
    ...
    abiToken = [{
            inputs: [{ internalType: "string", name: "_name", type: "string" }, { internalType: "string", name: "_symbol", type: "string" }, { internalType: "uint256", name: "_cap", type: "uint256" }, { internalType: "uint256", name: "_dec", type: "uint256" }, { internalType: "uint256", name: "_supply", type: "uint256" }, { internalType: "address", name: "_owner", type: "address" }],
            stateMutability: "nonpayable",
            type: "constructor"
            ...
            stateMutability: "view",
            type: "function"
        }, { inputs: [{ internalType: "address", name: "", type: "address" }], name: "balances", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "uint256", name: "amount", type: "uint256" }], name: "burn", outputs: [], stateMutability: "nonpayable", type: "function" }, { inputs: [{ internalType: "address", name: "from", type: "address" }, { internalType: "uint256", name: "amount", type: "uint256" }], name: "burnFrom", outputs: [], stateMutability: "nonpayable", type: "function" },
        { inputs: [], name: "cap", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, { inputs: [], name: "decimals", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "address", name: "recipient", type: "address" }, { internalType: "uint256", name: "amount", type: "uint256" }], name: "mint", outputs: [], stateMutability: "nonpayable", type: "function" }, {
            inputs: [],
            name: "name",
            outputs: [{ internalType: "string", name: "", type: "string" }],
            stateMutability: "view",
            type: "function"
        }, { inputs: [], name: "owner", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "address", name: "newOwner", type: "address" }], name: "setOwner", outputs: [], stateMutability: "nonpayable", type: "function" }, { inputs: [], name: "symbol", outputs: [{ internalType: "string", name: "", type: "string" }], stateMutability: "view", type: "function" }, {
            inputs: [],
            name: "totalSupply",
            outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
            stateMutability: "view",
...
function init() {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(a) {
        ...
        contract.on(filter, function(b, d, f, e, k, c, g) {
...
function makeTable() {
    var a, b, d, f, e, k, c, g, h, m, n, q;
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(l) {
        switch (l.nextAddress) {
            case 1:
                return a = "", l.yield(contract.myTokens({ from: myAddress }), 2);
            case 2:
                b = l.yieldResult;
                if (b == []) { l.jumpTo(3); break }
                d = b;
                f = 0;
            case 4:
                if (!(f < d.length)) { l.jumpTo(3); break }
                e = d[f];
                k = new ethers.Contract(e, abiToken, provider);
                return l.yield(k.name(), 7);
            case 7:
                return c = l.yieldResult, l.yield(k.symbol(), 8);
            case 8:
                return g = l.yieldResult, l.yield(k.cap(), 9);
            case 9:
                return h = l.yieldResult,
                    l.yield(k.decimals(), 10);
            case 10:
                return m = l.yieldResult, l.yield(k.totalSupply(), 11);
            case 11:
                n = l.yieldResult;
                q = Number(f + 1);
                a = a + "<tr><td>" + q + '</td><td><a title="View on explorer" target="_blank" href="' + tracker + "token/" + e + '">' + e + "</a></td><td>" + c + "</td><td>" + g + "</td><td>" + ethers.utils.formatUnits(h, m) + "</td><td>" + m + "</td><td>" + ethers.utils.formatUnits(n, m) + '</td><td><span title="Admin panel" class="clickable" onclick="tokenAdmin(\'' + e + '\')">admin</span></td><td><span title="Add to wallet" class="clickable" onclick="watchToken(\'' +
                    e + "', '" + g + "', " + m + ')">add</span></td>';
                a += "</tr>";
                f++;
                l.jumpTo(4);
...
function tokenAdmin(a) {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(c) {
        switch (c.nextAddress) {
            case 1:
                return thisAddress = a, $("#admin").show(), $("#thisAddr").html(a), $("#viewThis").html('<a title="View on explorer" target="_blank" href="' + tracker + "token/" + a + '">' + a + "</a>"), contractThis = new ethers.Contract(a, abiToken, provider), contractThisSign = contractThis.connect(signer), c.yield(contractThis.name(), 2);
            case 2:
                return b = c.yieldResult, $("#thisName").html(b), c.yield(contractThis.symbol(),
                    3);
            case 3:
                return d = c.yieldResult, $("#thisSymbol").html(d), c.yield(contractThis.decimals(), 4);
            case 4:
                return thisDecimals = c.yieldResult, $("#thisDec").html(Number(thisDecimals)), c.yield(contractThis.cap(), 5);
            case 5:
                return f = c.yieldResult, $("#thisCap").html(ethers.utils.formatUnits(f, thisDecimals)), c.yield(contractThis.totalSupply(), 6);
            case 6:
                return e = c.yieldResult, $("#thisSupply").html(ethers.utils.formatUnits(e, thisDecimals)), c.yield(contractThis.balanceOf(myAddress), 7);
            case 7:
                k = c.yieldResult, $("#thisBalance").html(ethers.utils.formatUnits(k,
                    thisDecimals)), $("#mintTo").val(myAddress), c.jumpToEnd()
        }
    })
}

function renewBalances() {
    var a, b;
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(d) {
        if (1 == d.nextAddress) return makeTable(), d.yield(contractThis.totalSupply(), 2);
        if (3 != d.nextAddress) return a = d.yieldResult, $("#thisSupply").html(ethers.utils.formatUnits(a, thisDecimals)), d.yield(contractThis.balanceOf(myAddress), 3);
        b = d.yieldResult;
...
$("#mintBtn").click(function() {
    var a, b;
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(d) {
        if (1 == d.nextAddress) return a = ethers.utils.parseUnits($("#mintAmount").val(), thisDecimals), b = $("#mintTo").val(), a && b ? d.yield(contractThisSign.mint(String(b), String(a)), 3) : d.jumpTo(0);
...
$("#burnBtn").click(function() {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(b) {
        if (1 == b.nextAddress) return (a = ethers.utils.parseUnits($("#burnAmount").val(), thisDecimals)) ? b.yield(contractThisSign.burn(String(a)), 3) : b.jumpTo(0);
...
$("#changeOwner").click(function() {
    var a;
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(b) {
        if (1 == b.nextAddress) return (a = $("#newOwner").val()) ? b.yield(contractThisSign.setOwner(String(a)), 3) : b.jumpTo(0);
        if (4 != b.nextAddress) return tx = b.yieldResult, b.yield(tx.wait(), 4);
        init();
        b.jumpToEnd()
    })
...
function watchToken(a, b, d) {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(f) {
        ethereum.request({ method: "wallet_watchAsset", params: { type: "ERC20", options: { address: String(a), symbol: String(b), decimals: String(d) } } });
        f.jumpToEnd()
    })
}
$("#buildbtn").click(function() {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(c) {
        if (1 == c.nextAddress) {
            ...
            k = $("#newto").val();
            "" == k && (k = myAddress);
            if (!("" != a && "" != b && 0 < Number(d) && Number(e) <= Number(d) && f && Number(f) <= Number(maxDecimals))) return Number(e) > Number(d) ? $("#errors").html("Error: supply can not be more than cap!") : $("#errors").html("Error: fields are empty or incorrect!"),
                c.jumpTo(0);
            $("#errors").html("");
            return c.yield(contractSign.createToken(String(a), String(b), String(d), String(f), String(e), String(k), { value: builderCost }), 3)
        }
